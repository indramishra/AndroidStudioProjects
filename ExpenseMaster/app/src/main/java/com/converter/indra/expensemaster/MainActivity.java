...
public class MainActivity extends AppCompatActivity
    ...
    ImageButton btn_add,btn_setting,btn_info,btn_graph;
    Button btn_income,btn_category;
    Spinner spinner;
    MyDbHelper mdb;
    Cursor c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* spinner=(Spinner)findViewById(R.id.spinner);
        ArrayAdapter<CharSequence> list=ArrayAdapter.createFromResource(this,R.array.context_names,android.R.layout.simple_spinner_item);
